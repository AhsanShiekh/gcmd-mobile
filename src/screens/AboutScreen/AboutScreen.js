...
import bilal from "../../../assets/staff/sir-bilal-min.jpeg";
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          Diagnostics facility located at Lahore, has State-of-the-art
          laboratory facilities and infrastructure that uses extremely sensitive
          and specific protocols to enable detection of low-level, early-stage
          infections as well as latest and most advanced technology for PCR,
          Routine and Special chemistry. GCMD houses RealTime PCR machines from
          Sacace Biotechnologies (Italy), Cepheid USA (SmartCycler II) and
          GenExpert, the most sensitive & specific FDA approved
          systems/technique for DNA/RNA detection and quantification currently
          available. For routine and special chemistry GCMD has systems from
          Roche and Biomeriex.
        </AppText>
        ...
        >
          ...
          outstanding technology and professional competency to meet the needs
          of their customers and also maintains the quality system that conforms
          to the requirements of ISO 9001:2015 and applicable regulatory
          requirements. The GCMD is registered with Punjab Health Care
          Commission (PHC Registration No. R-26066) and also DAS (UK) certified
          Quality Management System as met the requirements of ISO 9001: 2015
          (Certificate No. DAS 59297704/19/Q Rev: 001). GCMD was also ISO 9001:
          2015 RICI Certified Lab. The Lab is also affiliated with Armed Forces
          Institute of Pathology (AFIP) and College of American Pathologist
          (CAP) for External Quality Assurance.
        </AppText>
        ...
        <AppText
          ...
          center
        >
          In the current scenario of novel coronavirus pandemic, a large number
          of COVID-19 suspected people need to be tested by the most sensitive
          and specific method like Real-Time PCR to minimize community
          transmission, therefore, GCMD has decided to extend the Real-Time PCR
          facility to the specific diagnosis of novel coronavirus
          2019-nCoV/SARS-CoV-2 in clinical, suspected as well as for normal
          healthy Individuals (for certain purposes). GCMD has affiliation
          regarding Covi19 External Quality Assurance, from NIH Pakistan and LGC
          UK.
        </AppText>
        ...
        >
          ...
          preflight testing as PIA, SALAM AIR, SERENE AIR, AIR ARABIA, FLY
          DUBAI, AIR BLUE, TURKISH AIRLINE, PEGASUS AIRLINE, ETIHAD AIR,
          EMIRATES, GULF AIR, QATAR AIR and OMAN AIR. GCMD assures high quality,
          timely and accurate testing and facilitation to the passengers through
          online reports having Bar-Codes so that they could be scanned
          anywhere. 27/7 helplines are also open for passengers. Passengers
          could be entertained through home sampling or by our collection
          centers.
        </AppText>
        ...
        <AppText
          ...
          center
        >
          In the current scenario, where certain UAE states have demanded a
          Rapid PCR test, within a specific time frame and preferably within
          Airport premises, GCMD is honored to offering its services at
          international Airports i.e; Allama Iqbal International Airport Lahore
          and Faisalabad International Airport and Bacha Khan International
          Airport.
        </AppText>
