    ...
    <SafeAreaView style={doctorsScreenStyles.root}>
      ...
      <ScrollView style={doctorsScreenStyles.cardsContainer}>
        <View style={doctorsScreenStyles.card}>
          <Image style={doctorsScreenStyles.cardImage} source={drAgha} />
          <AppText variant={"h4"} color={"black"} center font={"Raleway"}>
            Dr. MUHAMMAD AFAAQ AGHA
          </AppText>
          <AppText variant={"h5"} color={"black"} center font={"Raleway"}>
            M.B.B.S
          </AppText>
          <AppText variant={"h5"} color={"black"} center font={"Raleway"}>
        ...
        <View style={doctorsScreenStyles.line} />
        <View style={doctorsScreenStyles.card}>
          <Image style={doctorsScreenStyles.cardImage} source={drQaiser} />
          <AppText variant={"h4"} color={"black"} center font={"Raleway"}>
            Dr. QAISER TAUQIR AHMAD
          </AppText>
          <AppText variant={"h5"} color={"black"} center font={"Raleway"}>
            M.B.B.S
          </AppText>
